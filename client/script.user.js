...
(function () {
  ...
  function mod() {
    ...
    this.appRoutes = {
      ...
      settings: isDev
        ? `http://localhost:${port}/me/settings`
        : `https://mod.czrsd.com/me/settings`,
      logout: isDev
...
`,
    ...
    showTournament(data) {
      ...
      byId("play-btn").addEventListener("click", (e) => {
        ...
        let passwordIncorrect = setInterval(() => {
    ...
    showCountdownOverlay(data) {
      ...
      const cdInterval = setInterval(() => {
        ...
        if (remainingTime <= 0) {
          ...
          if (round === 1) keypress("Escape", "Escape");
        }
      }, 1000);
    },
